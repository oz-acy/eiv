 ...
 *
 *  @file main.cpp
 *  @author oZ/acy (ñºâÍåéçWék)
 *  @brief EIVÇÃWinMain()
 *
 *  @date 2016.2.29  èCê≥ (v0.35)
 *  @date 2016.10.11 èCê≥ (v0.35 again) liburaniaÇÃédûÈùÃçXÇ…í«ún
 *  @date 2019.4.24  èCê≥ (v0.38) èÑÊTèáéwíËÇ…Ç©Ç©ÇÈù∞í£
 *//*
